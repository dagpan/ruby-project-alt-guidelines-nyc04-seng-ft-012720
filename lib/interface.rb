...
def display_user_menu(user)
   ...
   if user_choice == 1
      display_view_pharmacies_menu(user)
...
def display_view_contributions_menu(user)
   ...
   display_view_contributions_menu_choice
...
def display_edit_contributions_menu(user)
   ...
   display_edit_contributions_menu_choice
...
def display_delete_contributions_menu(user)
   ...
   display_delete_contributions_menu_choice
...
def display_find_pharmacy_menu(user)
   ...
   display_find_pharmacy_menu_choice
...
def display_add_contributions_menu
   system("clear")
   main_title
   main_menu
   user_menu_header(user)
   add_contributions_header
   display_add_contributions_menu_choice
...
def display_add_pharmacy_menu
   system("clear")
   main_title
   main_menu
   user_menu_header(user)
   add_pharmacy_header
   display_add_pharmacy_menu_choice
